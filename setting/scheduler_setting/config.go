...
const (
	...
	ObservabilityDiagnosticLevelFull       = "full"
	ObservabilityDiagnosticLevelErrorsOnly = "errors_only"
	ObservabilityDiagnosticLevelMinimal    = "minimal"
)
...
type SchedulerSetting struct {
	...
	ObservabilityPerformanceModeEnabled    bool                                 `json:"observability_performance_mode_enabled"`
	ObservabilityDiagnosticLevel           string                               `json:"observability_diagnostic_level"`
	ObservabilityClientRequestTraceEnabled bool                                 `json:"observability_client_request_trace_enabled"`
	ObservabilityScoreEventEnabled         bool                                 `json:"observability_score_event_enabled"`
	ObservabilityCandidateDetailEnabled    bool                                 `json:"observability_candidate_detail_enabled"`
	QueueEnabled                           bool                                 `json:"queue_enabled"`
...
var schedulerSetting = SchedulerSetting{
	...
	ObservabilityPerformanceModeEnabled:    true,
	ObservabilityDiagnosticLevel:           ObservabilityDiagnosticLevelErrorsOnly,
	ObservabilityClientRequestTraceEnabled: false,
	ObservabilityScoreEventEnabled:         false,
	ObservabilityCandidateDetailEnabled:    false,
	QueueEnabled:                           true,
...
func defaultSchedulerSetting() SchedulerSetting {
	...
	setting.ObservabilityDiagnosticLevel = ObservabilityDiagnosticLevelErrorsOnly
	setting.ObservabilityClientRequestTraceEnabled = false
	setting.ObservabilityScoreEventEnabled = false
	setting.ObservabilityCandidateDetailEnabled = false
