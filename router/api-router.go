...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.POST("/channel/balance_monitor/refresh", middleware.AdminAuth(), controller.RefreshChannelBalanceMonitor)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/:id/accounts/:credential_index/refresh-attribution", controller.RefreshChannelAccountUsageAttribution)
			...
			channelRoute.POST("/:id/clear_failure_avoidance", controller.ClearChannelFailureAvoidance)
			channelRoute.POST("/:id/recover_health", controller.RecoverChannelHealth)
		...
		modelGatewayRoute.Use(middleware.AdminAuth())
		{
			...
			modelGatewayRoute.POST("/observability/runtime/clear_circuit", controller.ClearModelGatewayRuntimeCircuit)
			modelGatewayRoute.GET("/observability/health-check/queue", controller.GetModelGatewayHealthCheckQueue)
			modelGatewayRoute.POST("/observability/health-check/probe", controller.RunModelGatewayHealthCheckProbe)
			...
			modelGatewayRoute.PATCH("/profit_monitor/config", controller.UpdateModelGatewayProfitMonitorConfig)
			...
			modelGatewayRoute.POST("/profit_monitor/recommendations", controller.CreateModelGatewayProfitMonitorRecommendation)
			modelGatewayRoute.PATCH("/profit_monitor/recommendations/:id/decision", controller.UpdateModelGatewayProfitMonitorRecommendationDecision)
			modelGatewayRoute.GET("/profit_monitor/canary_tasks", controller.ListModelGatewayProfitMonitorCanaryTasks)
			modelGatewayRoute.POST("/profit_monitor/canary_tasks", controller.CreateModelGatewayProfitMonitorCanaryTask)
			modelGatewayRoute.PATCH("/profit_monitor/canary_tasks/:id", controller.UpdateModelGatewayProfitMonitorCanaryTask)
			modelGatewayRoute.GET("/profit_monitor/resources", controller.ListModelGatewayProfitMonitorResources)
			modelGatewayRoute.POST("/profit_monitor/resources", controller.CreateModelGatewayProfitMonitorResource)
			modelGatewayRoute.PATCH("/profit_monitor/resources/:id", controller.UpdateModelGatewayProfitMonitorResource)
			modelGatewayRoute.DELETE("/profit_monitor/resources/:id", controller.DeleteModelGatewayProfitMonitorResource)
