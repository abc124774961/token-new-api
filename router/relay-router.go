...
func SetRelayRouter(router *gin.Engine) {
	...
	useRelayRootMiddleware(relayRouter)
	SetRelayRoutes(relayRouter)
}

func useRelayRootMiddleware(router *gin.RouterGroup) {
...
func SetRelayRoutes(router *gin.RouterGroup) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.Distribute(), middleware.ModelGatewayTrafficRecorder())
	{
	...
	}
	{
		...
		httpRouter.Use(middleware.ModelGatewayTrafficRecorder())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.Distribute(), middleware.ModelGatewayTrafficRecorder())
	{
	...
	relayGeminiRouter.Use(middleware.ModelGatewayTrafficRecorder())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.Distribute(), middleware.ModelGatewayTrafficRecorder())
	{
