	...
	records := []model.ModelExecutionRecord{
		{
			...
			TTFTMs:            120,
			ScoreTotal:        0.93,
			ScoreBreakdown:    mustObservationJSON(map[string]float64{"completion_rate": 1, "ttft_latency": 0.8, "concurrency_load": 0.9, "cost": 0.7, "group_priority": 1}),
		...
		},
		{
			...
			TTFTMs:            260,
			ScoreTotal:        0.62,
			ScoreBreakdown:    mustObservationJSON(map[string]float64{"completion_rate": 0.55, "ttft_latency": 0.5, "concurrency_load": 0.6, "cost": 0.8, "group_priority": 0.95}),
			CandidateGroups:   candidateDefaultVIP,
		...
		},
		{
			...
			ScoreTotal:        0.67,
			ScoreBreakdown:    mustObservationJSON(map[string]float64{"completion_rate": 0.4, "ttft_latency": 0.65, "concurrency_load": 0.55, "cost": 0.75, "group_priority": 1}),
		...
		},
		{
			...
			TTFTMs:            100,
			ScoreTotal:        0.96,
			ScoreBreakdown:    mustObservationJSON(map[string]float64{"completion_rate": 0.96, "ttft_latency": 0.9, "concurrency_load": 0.85, "cost": 0.6, "group_priority": 0.7}),
		...
		},
		{
			...
			TTFTMs:            140,
			ScoreTotal:        0.89,
			ScoreBreakdown:    mustObservationJSON(map[string]float64{"completion_rate": 0.98, "ttft_latency": 0.75, "concurrency_load": 0.7, "cost": 0.65, "group_priority": 0.9}),
		...
		},
		{
			...
			DurationMs:        900,
			ScoreTotal:        0.58,
			ScoreBreakdown:    mustObservationJSON(map[string]float64{"completion_rate": 0.35, "ttft_latency": 0.45, "concurrency_load": 0.5, "cost": 0.95, "group_priority": 1}),
			CandidateGroups:   candidateDefaultVIP,
