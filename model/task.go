...
type TaskPrivateData struct {
	...
	BillingSource     string              `json:"billing_source,omitempty"`     // wallet / subscription / subscription_wallet
	SubscriptionId    int                 `json:"subscription_id,omitempty"`    // 订阅 ID，用于订阅退款
	SubscriptionQuota int                 `json:"subscription_quota,omitempty"` // 当前任务已消耗的订阅额度
	WalletQuota       int                 `json:"wallet_quota,omitempty"`       // 当前任务已消耗的钱包额度
...
type TaskBillingContext struct {
	...
	BillingPreference string             `json:"billing_preference,omitempty"` // 用户提交任务时的计费偏好
}
